...
(function() {
  var activate, deactivate, initializeListGroup, initializeRaty, property;
  ...
  initializeListGroup = function() {
    return $(".list-group-item").click(function(event) {
      var assignID, assignmentField, checkboxID, checkedField, serviceID, serviceListing;
      serviceListing = $(this);
      ...
      if ($(event.target).hasClass("selected")) {
        if ($(checkedField).val() === 'true') {
          ...
          return activate(serviceListing, assignID, serviceID, checkedField);
        }
      } else {
  ...
  activate = function(serviceListing, assignID, serviceID, checkedField) {
    var CAServiceID, current, currentActive;
    ...
    if (current === "false") {
      return $('#confirmed' + serviceID + '-' + assignID).show(400);
    }
  };
