authorization do
  role :admin do
    ...
    has_permission_on :properties, :to => [:index, :show, :new, :create, :edit, :update, :destroy, :view_completed, :assign_services, :show_property]
  ...
  role :propertyowner do
    includes :guest
    has_permission_on :users, :to => [:show, :edit, :update]
    has_permission_on :properties, :to => [:new, :create, :show, :edit, :update, :destroy, :assign_services, :show_property]
    has_permission_on :master_service_requests, :to => [:new, :create, :show, :edit, :update, :destroy, :pause]
  ...
  role :serviceowner do
    ...
    has_permission_on :properties, :to => [:new, :create, :show, :show_property]
  end
